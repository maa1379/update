...
var getNeededScripts = function(o,c) {	
	...
	if (!c.data('version') || !c.data('version').toString().match(/5./gi)) {
		...
		c.find('.tp-caption, .tp-assets-layer, .rs-background-video-layer').each(function(){
			var _nc = jQuery(this);
...
var initSlider = function (container,opt) {
    ...
    opt.slayers = container.find('.tp-assets-layers');
 ...
 var runSlider = function(container,opt) {
	...
	if (!container.hasClass("revslider-initialised")) {
		...
		container.find('.tp-caption, .rs-background-video-layer').each(function(i) {
			...
			if (_nc.hasClass("tp-assets-layer") && _R.handleStaticLayers) {
		...
		loadImages(container.find('.tp-assets-layers'),opt,0,true);

		waitForCurrentImages(container.find('.tp-assets-layers'),opt,function() {
			container.find('.tp-assets-layers img').each(function() {
				var e = jQuery(this),
				...
				if (opt.layersonhover)					
					jQuery.each(opt.layersonhover,function(i,tnc) {		
						...
						var cli = tnc.data('closestli') || tnc.closest('.tp-revslider-slidesli'),
							stl = tnc.data('staticli') || tnc.closest('.tp-assets-layers');
