...
*					- made the demo site all assets local HTML pages so they can be run locally by a developer
...
//---- TweenLite instance methods -----------------------------------------------------------------------------
		...
		p._init = function() {
			...
			if (initPlugins) {
				TweenLite._onPluginEvent("_onInitAllProps", this); //reorders the array in order of priority. Uses a assets TweenPlugin method in order to minimize file size in TweenLite
			}
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push( function() {
	...
	_gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin","TweenLite"], function(TweenPlugin, TweenLite) {
		 ...
		 * wrapped into a separate assets method of CSSPlugin instead of being integrated into all regular className tweens
