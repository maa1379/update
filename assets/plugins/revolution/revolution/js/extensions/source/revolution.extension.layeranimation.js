...
jQuery.extend(true,_R, {
	...
	*************************************/	
	animateTheCaptions : function(obj)  {		
		...
		opt.layers["static"] = opt.layers["static"] || opt.c.find('.tp-assets-layers').find('.tp-caption');
	...
	********************************************/	
	prepareSingleCaption : function(obj) {
		...
		if (_._li===undefined) 
			if (_nc.hasClass("tp-assets-layer")) {
				_._isstatic = true;
				_._li = _nc.closest('.tp-assets-layers');
	...
	********************************************/	
	createTimelineStructure : function(opt) {
		...
		//GO THROUGH ALL LI
		opt.c.find('.tp-revslider-slidesli, .tp-assets-layers').each(function() {
	...
	***************************************/
	...
	removeTheCaptions : function(actli,opt) {	
		...
		/*if (opt.layers["assets"])
			jQuery.each(opt.layers["assets"], function(i,a) { allcaptions.push(a); });*/
